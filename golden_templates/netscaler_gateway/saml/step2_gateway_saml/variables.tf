...
variable "okta_certfile_name" {
  type        = string
  description = "okta_certfile_name"
}
...
variable "authenticationsamlaction_samlredirecturl" {
  type        = string
  description = "Gateway authenticationsamlaction samlredirecturl"
}
variable "authenticationsamlaction_samluserfield" {
  type        = string
  description = "Gateway authenticationsamlaction samluserfield"
}
variable "authenticationsamlaction_samlissuername" {
  type        = string
  description = "Gateway authenticationsamlaction samlissuername"
}
variable "authenticationsamlaction_logouturl" {
  type        = string
  description = "Gateway authenticationsamlaction logouturl"
}
